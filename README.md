...
Scripts:
- **Transformations.R**: R script to load, tidy and transform the corrected data tables (*FGF_all_pooled_raw.csv* and *scaling_pooled.csv*).
...
- **figures_*n*-*Sm*.R**: R scripts to generate all plots present in the corresponding figures in the published article.
